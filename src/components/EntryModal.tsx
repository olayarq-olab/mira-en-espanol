    ...
    <AnimatePresence>
      {entry && (
        <motion.div
          ...
          className="fixed inset-0 z-50 flex items-start justify-center bg-foreground/40 pt-[10vh] px-4"
          onClick={onClose}
        >
          <motion.div
            ...
            className="bg-background border border-foreground/20 w-full max-w-3xl max-h-[75vh] overflow-y-auto"
          ...
          >
            ...
            <div className="border-b border-foreground/10 p-8">
              ...
              <p className="font-display text-xl leading-snug text-foreground/80">
                {entry.title}
              </p>
            </div>

            {/* Metadata */}
            <div className="border-b border-foreground/10 p-8 grid grid-cols-3 gap-6">
              <div>
            ...
            {/* Status */}
            {entry.flagged && (
              <div className="border-b border-foreground/10 px-8 py-4 flex items-center gap-3 bg-accent/5">
                <span className="inline-block w-2 h-2 bg-accent" />
                <span className="font-mono-ui text-xs uppercase text-accent">
            ...
            <div className="p-8">
              ...
              <p className="text-base leading-relaxed max-w-[60ch]">
                {entry.excerpt}
              </p>
            </div>
