    ...
    <AnimatePresence>
      {cartoon && (
        <motion.div
          ...
          className="fixed inset-0 z-50 flex items-start justify-center bg-foreground/40 pt-[5vh] px-4"
          onClick={onClose}
        >
          <motion.div
            ...
            className="bg-background border border-foreground/20 w-full max-w-3xl max-h-[88vh] overflow-y-auto"
          ...
          >
            ...
            {/* Image */}
            <div className="border-b border-foreground/10 bg-muted flex items-center justify-center p-6">
              <img
